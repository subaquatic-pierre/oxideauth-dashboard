...
import { CustomersFilters } from '@/components/dashboard/customer/customersFilters';
import { CustomersTable } from '@/components/dashboard/customer/customersTables';
import type { Customer } from '@/components/dashboard/customer/customersTables';
